...
const FLIP_NOTE_ITEMS = [
  { photo: '/bd-lubimy/photos/old/f11.jpg', note: 'Какие' },
  { photo: '/bd-lubimy/photos/old/f12.jpg', note: 'цифры' },
  { photo: '/bd-lubimy/photos/old/f13.jpg', note: 'в' },
]

const FLIP_NOTE_ITEMS2 = [
  { photo: '/bd-lubimy/photos/old/f21.jpg', note: 'парижском' },
  { photo: '/bd-lubimy/photos/old/f22.jpg', note: 'кабаре' },
  { photo: '/bd-lubimy/photos/old/f23.jpg', note: 'написал' },
  { photo: '/bd-lubimy/photos/old/f24.jpg', note: 'брюнет' },
]

const FLIP_NOTE_ITEMS3 = [
  { photo: '/bd-lubimy/photos/old/f31.jpg', note: 'после' },
  { photo: '/bd-lubimy/photos/old/f32.jpg', note: 'того' },
  { photo: '/bd-lubimy/photos/old/f33.jpg', note: 'как' },
]

const FLIP_NOTE_ITEMS4 = [
  { photo: '/bd-lubimy/photos/old/f41.jpg', note: 'угостил' },
  { photo: '/bd-lubimy/photos/old/f42.jpg', note: 'меня' },
  { photo: '/bd-lubimy/photos/old/f43.jpg', note: 'вином' },
]
...
export default function OldPage() {
  ...
  return (
    <div className="page old-page">
      ...
      <PhotoTextBlock
        layout="photo-left"
        photo="/bd-lubimy/photos/old/1.jpg"
        text={
          <>
      ...
      <PhotoTextBlock
        layout="photo-center"
        photo="/bd-lubimy/photos/old/2.jpg"
        text={
          <>
      ...
      <PhotoTextBlock
        layout="photo-right"
        photo="/bd-lubimy/photos/old/3.jpg"
        text={
          <>
      ...
      <ThreePhotosRow
        photos={['/bd-lubimy/photos/old/5.jpg', '/bd-lubimy/photos/old/6.jpg', '/bd-lubimy/photos/old/7.jpg']}
      />

      <PhotoTextBlock
        layout="photo-right"
        photo="/bd-lubimy/photos/old/8.jpg"
      ...
      {showAfterGift && (
        <>
          <PhotoTextBlock
            ...
            photo="/bd-lubimy/photos/old/9.jpg"
            text={
              <>
          ...
          <PhotoTextBlock
            layout="photo-right"
            className="photo-horizontal"
            photo="/bd-lubimy/photos/old/10.jpg"
            text={
              <>
          ...
          <PhotoTextBlock
            layout="photo-left"
            className="photo-horizontal"
            photo="/bd-lubimy/photos/old/11.jpg"
          ...
          <PhotoTextBlock
            layout="photo-right"
            photo="/bd-lubimy/photos/old/12.jpg"
            text={
              <>
          ...
          <PhotoTextBlock
            layout="photo-left"
            className="photo-horizontal"
            photo="/bd-lubimy/photos/old/13.jpg"
            text2={
              <>
          ...
          <PhotoTextBlock
            layout="photo-left"
            className="photo-horizontal"
            photo="/bd-lubimy/photos/old/14.jpg"
            text2={
              <>
